...
import ninesstack.nmesos.cli.model.DefaultValues
import ninesstack.nmesos.cli.model.{Cmd, ReleaseAction, DockerEnvAction}
import ninesstack.nmesos.commands.ReleaseCommand
import ninesstack.nmesos.config.ConfigReader
import ninesstack.nmesos.config.ConfigReader.ValidConfig
import ninesstack.nmesos.config.model.CmdConfig
import ninesstack.nmesos.singularity.ModelConversions.toSingularityRequest
import ninesstack.nmesos.singularity.{RealSingularityManager, SingularityManager}
