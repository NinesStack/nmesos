...
object CliManager {
  import ninesstack.nmesos.cli.model._
  import ninesstack.nmesos.commands._
  import ninesstack.nmesos.config._
  import ninesstack.nmesos.config.model._
  import ninesstack.nmesos.config.ConfigReader._
  import ninesstack.nmesos.util._
